    ...
    <footer className="bg-stone-900 text-stone-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Brand */}
          <div>
            <h3 className="text-xl font-bold text-white mb-4">Kazi Constructions</h3>
            <p className="text-stone-400 mb-4">
              Premium interior design and construction company specializing in residential, commercial, hospitality, and healthcare projects since 1980.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-stone-400">
              <li>Mumbai, India</li>
              <li>Email: info@kaziconstructions.com</li>
        ...
        <div className="mt-12 pt-8 border-t border-stone-800 text-center text-stone-500 text-sm">
          <p>© {currentYear} Kazi Constructions. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
